...
Для `AK400 Digital` теперь есть собственная замена официальному `deepcool-digital`.
...
- при старте останавливает официальный `deepcool-digital`, чтобы не было конфликта

Как запустить из меню:
- `27. Собрать и установить DeepCool Companion`
- `28. Запустить DeepCool Companion`
